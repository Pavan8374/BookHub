        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ApplicatonUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ...
                    Carrrier = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderHeaders_AspNetUsers_ApplicatonUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingCarts_AspNetUsers_ApplicatonUserId",
                        column: x => x.ApplicatonUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, "Hyderabad", "A1 Solutions", "8883706744", "437723", "Telangaana", "1-19" },
                    { 3, "Hyderabad", "N1 Solutions", "8803606344", "437723", "Telangaana", "1-23" },
                    { 4, "Hyderabad", "c1 Solutions", "8803707344", "437723", "Telangaana", "1-34" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderHeaders_ApplicatonUserId",
                table: "OrderHeaders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCarts_ApplicatonUserId",
                table: "ShoppingCarts",
                column: "ApplicatonUserId");
